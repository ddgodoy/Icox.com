<?php
	...
	elseif (isset($_GET['Id'])){
		...
		//
		if (!empty($_GET['clear'])) {
			$oDominio->clearCambiosDelUsuario();
		}
		$arrayShowCambios = $oDominio->getCambiosDelUsuario();
		//
		$stUSUARIO_ID = $oDominio->getUsuarioId();
	...
	$oSmarty->assign('stCAMBIOS_USUARIO', $arrayShowCambios);
/*----------------------------------------------------------------------*/
